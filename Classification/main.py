...
def exp_main(args):
    ...
    if args.model  == 'TSDR_T':
        l = TSDR_T(data_context.shape[-1], args.lamdba, args.nu, args.hidden)
    elif args.model  == 'TSDR_P':
        l = TSDR_P(data_context.shape[-1], args.lamdba, args.nu, args.hidden)
    else:
